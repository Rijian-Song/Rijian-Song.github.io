...
The approved source baseline is `a2263b84183e33e00169baf09b574ef75c5a291c`. Build it independently, then purge its CSS with the same locked PurgeCSS executable as the candidate. Keep its generated output outside the site source. The deployment workflow provides an executable example.
